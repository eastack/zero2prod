...
impl SubscriberName {
    ...
    pub fn parse(s: String) -> Result<SubscriberName, String> {
        ...
        // Return `false` if any of out conditions have been violated
        if is_empty_or_whitespace || is_too_long || contains_forbidden_characters {
            tracing::error!(
                "Invalid subscriber name `{}` because is_empty_or_whitespace: {} is_too_long:{} contains_forbidden_characters:{}",
                s, is_empty_or_whitespace, is_too_long, contains_forbidden_characters);
